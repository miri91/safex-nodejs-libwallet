...
safexcore/build: boost safexcore
	...
	cd deps && '/c/Program Files (x86)/Microsoft Visual Studio/2017/Community/VC/Tools/MSVC/14.16.27023/bin/Hostx64/x64/lib.exe' /machine:x64 /def:libwin_wallet_wrapper.def
else
#linux, mac
safexcore/build: boost safexcore
	mkdir -p safexcore/build
